...
var RemoveFromCart = function RemoveFromCart(_ref) {
  ...
  var update = function update(cache, payload) {
    ...
    console.log('data.me.cart before', data.me.cart);
    data.me.cart = data.me.cart.filter(function (cartItem) {
      return cartItem.id !== cartItemId;
    });
    console.log('data.me.cart after', data.me.cart); // 3. Write it back to the cache
...
//# sourceMappingURL=_app.js.c52e7eaf36a246259014.hot-update.js.map