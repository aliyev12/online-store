...
const SingleItem = ({
  ...
  if (!data.item) return external_react_default.a.createElement("p", null, "No Item Found for ", id);
  return external_react_default.a.createElement(SingleItemStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Sick Fits | ", data.item.title)), external_react_default.a.createElement("img", {
    src: data.item.largeImage,
    alt: data.item.title
  }), external_react_default.a.createElement("div", {
    className: "details"
  }, external_react_default.a.createElement("h2", null, "Viewing ", data.item.title), external_react_default.a.createElement("p", null, data.item.description)));
};
...
/* harmony default export */ var item = __webpack_exports__["default"] = (({
  query
}) => external_react_default.a.createElement("div", null, external_react_default.a.createElement(components_SingleItem, {
  id: query.id
})));
